        ...
        <form>
          <table class="table table-striped" id="data-table">
            ...
            <tr>
              ...
              <td><input type="text" class="form-control" name="" placeholder="Ví dụ: Mường Thanh"></td>
            </tr>
            <tr>
              <th>Chất Lượng</th>
              <td>
                <select type="text" class="form-control" name="" placeholder="Ví dụ: 1.000.000">
                  <option>1 Sao</option>
                  <option>2 Sao</option>
                  <option>3 Sao</option>
                  <option>4 Sao</option>
           ...
           <tr>
             <th>Giá</th>
             <td><input type="text" class="form-control" name="" placeholder="Giá"></td>
           </tr>
           <tr>
            <th>Người Tạo</th>
