        ...
        <div class="panel-body">            
          ...
          <table class="table table-striped" id="data-table">
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href="<?= $this->url->build('Tours/adminviewtour') ?>" target="_blank" title="view"><span class="glyphicon glyphicon-eye-open"></span></a>
                <a href="<?= $this->url->build('Tours/adminedittour') ?>" target="_blank" title="edit"><span class="glyphicon glyphicon-pencil"></span></a>
